 ...
 * @author roah
 */
public final class TestCardMenu extends EditorMenuWindow {

    private final CardEditorSystem system;
    /**
     * Window used to add or remove card from the GUI.
     */
    public TestCardMenu(ElementManager screen, Element parent, CardEditorSystem system) {
        ...
        getWindow().setPosition(new Vector2f(getWindow().getPosition().x, 
                getWindow().getPosition().y-screen.getElementById("CloseRootButtonWin").getHeight()-15));

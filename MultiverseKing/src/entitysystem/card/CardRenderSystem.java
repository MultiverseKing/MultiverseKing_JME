...
public class CardRenderSystem extends EntitySystemAppState implements HexMapInputListener {
    ...
    private void castPreview(Card card) {
        ...
        if(activateCard(null)){
            ...
            app.getStateManager().getState(RoomMouseSystem.class).registerTileInputListener(this);
    ...
    private void closePreview() {
        ...
        app.getStateManager().getState(RoomMouseSystem.class).removeTileInputListener(this);
            ...
            switch (cardPreviewCast.getProperties().getCardMainType()) {
                ...
                case WORLD:
                    if (event == null) {
                         ...
                         * is canceled.
                         */
                        if (!app.getStateManager().getState(RoomMouseSystem.class).setCursorPulseMode(this)) {
                            return false;
                        }
                    } else {
                        /**
